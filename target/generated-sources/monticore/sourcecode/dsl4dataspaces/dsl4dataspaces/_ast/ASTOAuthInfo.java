...
/* Hookpoint: ClassContent:Annotations */
 ...
 public  class ASTOAuthInfo extends ASTCNode  implements dsl4dataspaces.dsl4dataspaces._ast.ASTConfigurationElements,dsl4dataspaces.dsl4dataspaces._ast.ASTDSL4DataspacesNode {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    return o instanceof ASTOAuthInfo;
...
/* Hookpoint: MethodContent:Annotations */
 public  ASTOAuthInfo deepClone (ASTOAuthInfo result)
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x59759 AST node type ASTOAuthInfo expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x53250 AST node type ASTOAuthInfo expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x06898 AST node type ASTOAuthInfo expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x23022 AST node type ASTOAuthInfo expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x28542 AST node type ASTOAuthInfo expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 protected  ASTOAuthInfo _construct ()

 {
    return dsl4dataspaces.dsl4dataspaces.DSL4DataspacesMill.oAuthInfoBuilder().uncheckedBuild();
}
