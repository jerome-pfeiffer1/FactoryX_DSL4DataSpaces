...
/* Hookpoint: ClassContent:Annotations */
 ...
 public  class ASTIdentityProviderConfig extends ASTCNode  implements dsl4dataspaces.dsl4dataspaces._ast.ASTConfigurationElements,dsl4dataspaces.dsl4dataspaces._ast.ASTDSL4DataspacesNode {
...
;
 ...
 protected  ASTIdentityProviderConfig()
 {
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    /* generated by template data.DeepEqualsWithOrder*/
      ...
      ASTIdentityProviderConfig comp;
    if ((o instanceof ASTIdentityProviderConfig)) {
      comp = (ASTIdentityProviderConfig) o;
    } else {
      return false;
    }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
    ...
    return o instanceof ASTIdentityProviderConfig;
...
/* Hookpoint: MethodContent:Annotations */
 public  ASTIdentityProviderConfig deepClone ()
...
/* Hookpoint: MethodContent:Annotations */
 public  ASTIdentityProviderConfig deepClone (ASTIdentityProviderConfig result)
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x32449 AST node type ASTIdentityProviderConfig expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.types.mcbasictypes._visitor.MCBasicTypesTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x47700 AST node type ASTIdentityProviderConfig expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x55232 AST node type ASTIdentityProviderConfig expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x96832 AST node type ASTIdentityProviderConfig expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
...

 {
  ...
  if (visitor instanceof dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x47408 AST node type ASTIdentityProviderConfig expected a visitor of type dsl4dataspaces.dsl4dataspaces._visitor.DSL4DataspacesTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...
/* Hookpoint: MethodContent:Annotations */
 protected  ASTIdentityProviderConfig _construct ()

 {
    return dsl4dataspaces.dsl4dataspaces.DSL4DataspacesMill.identityProviderConfigBuilder().uncheckedBuild();
}
