...
/* Hookpoint: MethodContent:Annotations */
 public  Optional<dsl4dataspaces.dsl4dataspaces._ast.ASTIdentificationData> parseIdentificationData (String fileName)
 throws java.io.IOException
 {
    /* generated by template _parser.ParseRule*/

  DSL4DataspacesAntlrParser parser = create(fileName);
  dsl4dataspaces.dsl4dataspaces._ast.ASTIdentificationData ast;
  ast = parser.identificationData().ret;
  if (parser.hasErrors()) {
    setError(true);
    return Optional.empty();
  }
...
/* Hookpoint: MethodContent:Annotations */
 public  Optional<dsl4dataspaces.dsl4dataspaces._ast.ASTIdentificationData> parseIdentificationData (java.io.Reader reader)
 throws java.io.IOException
 {
    /* generated by template _parser.ParseRuleReader*/
...
/* Hookpoint: MethodContent:Annotations */
 public  Optional<dsl4dataspaces.dsl4dataspaces._ast.ASTIdentificationData> parse_StringIdentificationData (String str)
 throws java.io.IOException
 {
    /* generated by template _parser.ParseRuleString*/

  return parseIdentificationData(new java.io.StringReader(str));
}
