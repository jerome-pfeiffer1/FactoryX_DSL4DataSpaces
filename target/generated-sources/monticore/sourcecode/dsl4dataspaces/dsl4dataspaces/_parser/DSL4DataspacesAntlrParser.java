...
public class DSL4DataspacesAntlrParser extends MCParser {
	...
	public static final int
		...
		LBRACK=49, RBRACK=50, OAUTH105516695=51, POLICY3312297266=52, USAGE82021761=53, 
		DATASCHEMAADDRESS258677641=54, ENDPOINTS2434569598=55, CLIENTID908408390=56, 
		IDPENDPOINT3356463978=57, CONTRACTOFFER3767399530=58, SECURITYPOLICY3506346130=59, 
		SUPPORTEDPROTOCOLS1268839373=60, BASEURL3962341598=61, LINKEDASSETID675711922=62, 
		DISCOVERY4173759920=63, CLOUDPUSH3868712687=64, LCURLY=65, ASSET93121264=66, 
		RCURLY=67, CONFIG2940175170=68, OPCUA105946286=69, TRUE3569038=70, FALSE97196323=71, 
		BOOLEAN64711720=72, BYTE3039496=73, SHORT109413500=74, INT104431=75, LONG3327612=76, 
		CHAR3052374=77, FLOAT97526364=78, DOUBLE2969009105=79, DE3201=80, EN3241=81, 
		NL3518=82, String=83, Num_Int=84, Name=85, Num_Double=86, Char=87, Num_Float=88, 
		WS=89, Num_Long=90, ML_COMMENT=91, SL_COMMENT=92, Digits=93;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'identity'", "'scope'", "'['", "']'", "'oauth'", "'policy'", "'Usage'", 
			"'dataSchemaAddress'", "'endpoints'", "'clientId'", "'idpEndpoint'", 
			"'contractOffer'", "'securityPolicy'", "'supportedProtocols'", "'baseUrl'", 
			"'linkedAssetID'", "'discovery'", "'cloudPush'", "'{'", "'asset'", "'}'", 
			"'config'", "'opcua'", "'true'", "'false'", "'boolean'", "'byte'", "'short'", 
			"'int'", "'long'", "'char'", "'float'", "'double'", "'de'", "'en'", "'nl'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LBRACK", "RBRACK", "OAUTH105516695", "POLICY3312297266", "USAGE82021761", 
			"DATASCHEMAADDRESS258677641", "ENDPOINTS2434569598", "CLIENTID908408390", 
			"IDPENDPOINT3356463978", "CONTRACTOFFER3767399530", "SECURITYPOLICY3506346130", 
			"SUPPORTEDPROTOCOLS1268839373", "BASEURL3962341598", "LINKEDASSETID675711922", 
			"DISCOVERY4173759920", "CLOUDPUSH3868712687", "LCURLY", "ASSET93121264", 
			"RCURLY", "CONFIG2940175170", "OPCUA105946286", "TRUE3569038", "FALSE97196323", 
			"BOOLEAN64711720", "BYTE3039496", "SHORT109413500", "INT104431", "LONG3327612", 
			"CHAR3052374", "FLOAT97526364", "DOUBLE2969009105", "DE3201", "EN3241", 
			"NL3518", "String", "Num_Int", "Name", "Num_Double", "Char", "Num_Float", 
			"WS", "Num_Long", "ML_COMMENT", "SL_COMMENT", "Digits"
		};
	}
	...
	public final DataSpaceConnectorConfigurationContext dataSpaceConnectorConfiguration() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 21)) & ~0x3f) == 0 && ((1L << (_la - 21)) & 285878391930881L) != 0) );
			setState(299);
			match(RCURLY);
			}
			_ctx.stop = _input.LT(-1);
	...
	public static class DiscoveryDataContext extends ParserRuleContext {
		...
		public TerminalNode URI84300() { return getToken(DSL4DataspacesAntlrParser.URI84300, 0); }
	...
	public final DiscoveryDataContext discoveryData() throws RecognitionException {
		...
		try {
			...
			_builder.setAssetID(_localctx.tmp0.ret);
			setState(317);
			match(SEMI);
			setState(318);
			...
			_builder.setBaseUrl(_localctx.tmp1.ret);
			setState(321);
			match(SEMI);
			setState(322);
			...
			_builder.setEndpoint(_localctx.tmp2.ret);
			setState(325);
			match(SEMI);
			setState(326);
			...
			_builder.setAssetMetaData(_localctx.tmp3.ret);
			setState(333);
			match(RCURLY);
			}
			_ctx.stop = _input.LT(-1);
	...
	public static class AssetMetaDataContext extends ParserRuleContext {
		...
		public TerminalNode SIDICODES2535023499() { return getToken(DSL4DataspacesAntlrParser.SIDICODES2535023499, 0); }
		...
		public TerminalNode DE3201() { return getToken(DSL4DataspacesAntlrParser.DE3201, 0); }
		public TerminalNode EN3241() { return getToken(DSL4DataspacesAntlrParser.EN3241, 0); }
		public TerminalNode NL3518() { return getToken(DSL4DataspacesAntlrParser.NL3518, 0); }
	...
	public final AssetMetaDataContext assetMetaData() throws RecognitionException {
		...
		try {
			...
			_builder.setCreated(_localctx.tmp6.ret);
			setState(385);
			match(SEMI);
			setState(386);
			...
			_builder.setModified(_localctx.tmp7.ret);
			setState(389);
			match(SEMI);
			setState(390);
	...
	public static class BaseUsageContext extends ParserRuleContext {
		...
		public StringLiteralContext tmp2;
		public StringLiteralContext tmp3;
		public AccessPolicyContext tmp4;
	...
	public final BaseUsageContext baseUsage() throws RecognitionException {
		...
		try {
			...
			_builder.setBaseUrl(_localctx.tmp0.ret);
			setState(407);
			match(SEMI);
			setState(408);
			match(ENDPOINT1741102485);
			...
			_builder.setEndpoint(_localctx.tmp1.ret);
			setState(411);
			match(SEMI);
			setState(412);
			...
			_builder.setDataAddress(_localctx.tmp2.ret);
			setState(415);
			match(SEMI);
			setState(416);
			...
			_builder.setSchemaAddress(_localctx.tmp3.ret);
			setState(419);
			match(SEMI);
			setState(420);
			((BaseUsageContext)_localctx).tmp4 = accessPolicy();
			_builder.setAccessPolicy(_localctx.tmp4.ret);
			setState(422);
			match(RCURLY);
			}
			_ctx.stop = _input.LT(-1);
	...
	public static class OPCUAUsageContext extends ParserRuleContext {
		...
		public StringLiteralContext tmp5;
		public StringLiteralContext tmp6;
		public AccessPolicyContext tmp7;
	...
	public final OPCUAUsageContext oPCUAUsage() throws RecognitionException {
		...
		try {
			...
			match(SEMI);
			setState(475);
			((OPCUAUsageContext)_localctx).tmp7 = accessPolicy();
			_builder.setAccessPolicy(_localctx.tmp7.ret);
			setState(477);
			match(RCURLY);
			}
			_ctx.stop = _input.LT(-1);
	...
	public static class EDCUsageContext extends ParserRuleContext {
		...
		public StringLiteralContext tmp5;
		public StringLiteralContext tmp6;
		public EDCPushEndpointsConfigContext tmp7;
		...
		public TerminalNode REGISTRIES2425415067() { return getToken(DSL4DataspacesAntlrParser.REGISTRIES2425415067, 0); }
	...
	public final EDCUsageContext eDCUsage() throws RecognitionException {
		...
		try {
			...
			{
			setState(487);
			((EDCUsageContext)_localctx).tmp1 = match(Name);
			 addToIteratedAttributeIfNotNull(_builder.getNameList(), convertName(((EDCUsageContext)_localctx).tmp1));
			}
			setState(495);
			_errHandler.sync(this);
			_la = _input.LA(1);
			...
			match(SEMI);
			setState(524);
			((EDCUsageContext)_localctx).tmp7 = eDCPushEndpointsConfig();
			_builder.setEDCPushEndpointsConfig(_localctx.tmp7.ret);
			setState(526);
			((EDCUsageContext)_localctx).tmp8 = accessPolicy();
			_builder.setAccessPolicy(_localctx.tmp8.ret);
			setState(528);
			match(RCURLY);
			}
			_ctx.stop = _input.LT(-1);
	...
	public final AccessPolicyContext accessPolicy() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==IDENTITY4159205566) {
				{
				setState(600);
				((AccessPolicyContext)_localctx).tmp5 = identityProviderConfig();
				_builder.setIdentityProviderConfig(_localctx.tmp5.ret);
				}
			}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==OAUTH105516695) {
				{
				setState(605);
				((AccessPolicyContext)_localctx).tmp6 = oAuthInfo();
				_builder.setOAuthInfo(_localctx.tmp6.ret);
				}
			}
	...
	public static class UsageContext extends ParserRuleContext {
		...
		public BaseUsageContext tmp28;
		public OPCUAUsageContext tmp29;
		public EDCUsageContext tmp30;
	...
	public final UsageContext usage() throws RecognitionException {
		...
		try {
			...
			case USAGE82021761:
				...
				{
				setState(775);
				((UsageContext)_localctx).tmp28 = baseUsage();
			...
			case OPCUA105946286:
				...
				{
				setState(778);
				((UsageContext)_localctx).tmp29 = oPCUAUsage();
			...
			case EDC100260:
				...
				{
				setState(781);
				((UsageContext)_localctx).tmp30 = eDCUsage();
				((UsageContext)_localctx).ret = ((UsageContext)_localctx).tmp30.ret;
				}
				break;
			default:
				throw new NoViableAltException(this);
